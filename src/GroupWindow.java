...
public class GroupWindow extends JFrame {
    ...
    {
        super(title);
        ModelDane modelData = new ModelDane();
        modelData.init();
        List<Class> groups = modelData.getGroups();
        GrupaModelTabeli grupaModelTabeli = new GrupaModelTabeli(modelData.getGroupColumns(), groups);
        StudentTableModel studentTableModel = new StudentTableModel(modelData.getStudentColumns(), modelData.getStudentsInGroup());
        groupTable.setModel(grupaModelTabeli);
        ...
        addGroup.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                else
                {
                    ...
                    newGroup.setNazwaGrupy(groupNameInput.getText());
                    newGroup.setMaksymalnaIloscStudentow(Integer.valueOf(sizeGroupInput.getText()));
                    groups.add(newGroup);
                    groupNameInput.setText("");
                    sizeGroupInput.setText("");
                    grupaModelTabeli.fireTableDataChanged();
        ...
        addStudent.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                else
                {
                    ...
                    newStudent.getImie(firstNameInput.getText());
                    newStudent.getNazwisko(lastNameInput.getText());
                    newStudent.setStanStudenta(StudentCondition.Obecny);
...
//                            break;
//                    }
                    newStudent.setRokUrodzenia(Integer.valueOf(yearOfBirthInput.getText()));
                    newStudent.setIloscPunktow(Double.valueOf(scoresInput.getText()));
